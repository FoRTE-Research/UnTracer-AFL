...
static const u8* fsrvonly_callback_64 = 
  ...
  "  /* Check if SHM region is already mapped. */\n"
  "\n"
  "  movq  __fsrvonly_area_ptr(%rip), %rdx\n"
  "  testq %rdx, %rdx\n"
  "  je    __fsrvonly_setup\n"
  "\n"
  "__fsrvonly_return:\n"
  ...
  "  /* Do not retry setup if we had previous failures. */\n"
  "\n"
  "  cmpb $0, __fsrvonly_setup_failure(%rip)\n"
  "  jne __fsrvonly_return\n"
  "\n"
  "  /* Check out if we have a global pointer on file. */\n"
  "\n"
#ifndef __APPLE__
  "  movq  __fsrvonly_global_area_ptr@GOTPCREL(%rip), %rdx\n"
  "  movq  (%rdx), %rdx\n"
#else
  "  movq  __fsrvonly_global_area_ptr(%rip), %rdx\n"
#endif /* !^__APPLE__ */
  "  testq %rdx, %rdx\n"
  "  je    __fsrvonly_setup_first\n"
  "\n"
  "  movq %rdx, __fsrvonly_area_ptr(%rip)\n"
  "  jmp  __fsrvonly_return\n" 
  "\n"
  ...
  "  movq %xmm15, 336(%rsp)\n"
  "\n"
  "  /* Map SHM, jumping to __fsrvonly_setup_abort if something goes wrong. */\n"
  "\n"
  "  /* The 64-bit ABI requires 16-byte stack alignment. We'll keep the\n"
  "     original stack ptr in the callee-saved r12. */\n"
  "\n"
  ...
  "\n"
  "  movq %rax, %rdx\n"
  "  movq %rax, __fsrvonly_area_ptr(%rip)\n"
  "\n"
#ifdef __APPLE__
  "  movq %rax, __fsrvonly_global_area_ptr(%rip)\n"
#else
  "  movq __fsrvonly_global_area_ptr@GOTPCREL(%rip), %rdx\n"
  "  movq %rax, (%rdx)\n"
#endif /* ^__APPLE__ */
  ...
  "\n"
  "  movq $4, %rdx               /* length    */\n"
  "  leaq __fsrvonly_temp(%rip), %rsi /* data      */\n"
  "  movq $" STRINGIFY((FORKSRV_FD + 1)) ", %rdi       /* file desc */\n"
  CALL_L64("write")
  "\n"
  "  cmpq $4, %rax\n"
  "  jne  __fsrvonly_fork_resume\n"
  "\n"
  ...
  "  cmpq $0, %rax\n"
  "  jl   __fsrvonly_die\n"
  "  je   __fsrvonly_fork_resume\n"
  "\n"
  "  /* In parent process: write PID to pipe, then wait for child. */\n"
  "\n"
  "  movl %eax, __fsrvonly_fork_pid(%rip)\n"
  "\n"
  "  movq $4, %rdx                   /* length    */\n"
  "  leaq __fsrvonly_fork_pid(%rip), %rsi /* data      */\n"
  "  movq $" STRINGIFY((FORKSRV_FD + 1)) ", %rdi             /* file desc */\n"
  CALL_L64("write")
  "\n"
  "  movq $0, %rdx                   /* no flags  */\n"
  "  leaq __fsrvonly_temp(%rip), %rsi     /* status    */\n"
  "  movq __fsrvonly_fork_pid(%rip), %rdi /* PID       */\n"
  CALL_L64("waitpid")
  "  cmpq $0, %rax\n"
  "  jle  __fsrvonly_die\n"
  "\n"
  ...
  "     shmget() / shmat() over and over again. */\n"
  "\n"
  "  incb __fsrvonly_setup_failure(%rip)\n"
  "\n"
  "  movq %r12, %rsp\n"
  "  popq %r12\n"
  "\n"
  ...
  "  .comm   __fsrvonly_area_ptr, 8\n"
#ifndef COVERAGE_ONLY
  "  .comm   __fsrvonly_prev_loc, 8\n"
#endif /* !COVERAGE_ONLY */
  "  .comm   __fsrvonly_fork_pid, 4\n"
  "  .comm   __fsrvonly_temp, 4\n"
  "  .comm   __fsrvonly_setup_failure, 1\n"

#else

  "  .lcomm   __fsrvonly_area_ptr, 8\n"
#ifndef COVERAGE_ONLY
  "  .lcomm   __fsrvonly_prev_loc, 8\n"
#endif /* !COVERAGE_ONLY */
  "  .lcomm   __fsrvonly_fork_pid, 4\n"
  "  .lcomm   __fsrvonly_temp, 4\n"
  "  .lcomm   __fsrvonly_setup_failure, 1\n"

#endif /* ^__APPLE__ */

  "  .comm    __fsrvonly_global_area_ptr, 8, 8\n"
  "\n"
  ".AFL_SHM_ENV:\n"
  "  .asciz \"" SHM_ENV_VAR "\"\n"
  "\n"
